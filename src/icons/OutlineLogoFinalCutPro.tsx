...
export interface OutlineLogoFinalCutProProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineLogoFinalCutPro: React.FC<OutlineLogoFinalCutProProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineLogoFinalCutPro.displayName = 'OutlineLogoFinalCutPro';

export default OutlineLogoFinalCutPro;