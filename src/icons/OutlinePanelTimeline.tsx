...
export interface OutlinePanelTimelineProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlinePanelTimeline: React.FC<OutlinePanelTimelineProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlinePanelTimeline.displayName = 'OutlinePanelTimeline';

export default OutlinePanelTimeline;