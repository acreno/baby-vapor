...
export interface OutlinePanelCommentsProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlinePanelComments: React.FC<OutlinePanelCommentsProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlinePanelComments.displayName = 'OutlinePanelComments';

export default OutlinePanelComments;