...
export interface OutlineEmojiProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineEmoji: React.FC<OutlineEmojiProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineEmoji.displayName = 'OutlineEmoji';

export default OutlineEmoji;