...
export interface OutlinePanelSidebarNavigationProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlinePanelSidebarNavigation: React.FC<OutlinePanelSidebarNavigationProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlinePanelSidebarNavigation.displayName = 'OutlinePanelSidebarNavigation';

export default OutlinePanelSidebarNavigation;