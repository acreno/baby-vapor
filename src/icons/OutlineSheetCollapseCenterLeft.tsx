...
export interface OutlineSheetCollapseCenterLeftProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineSheetCollapseCenterLeft: React.FC<OutlineSheetCollapseCenterLeftProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineSheetCollapseCenterLeft.displayName = 'OutlineSheetCollapseCenterLeft';

export default OutlineSheetCollapseCenterLeft;