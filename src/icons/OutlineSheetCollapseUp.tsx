...
export interface OutlineSheetCollapseUpProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineSheetCollapseUp: React.FC<OutlineSheetCollapseUpProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineSheetCollapseUp.displayName = 'OutlineSheetCollapseUp';

export default OutlineSheetCollapseUp;