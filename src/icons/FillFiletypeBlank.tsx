...
export interface FillFiletypeBlankProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const FillFiletypeBlank: React.FC<FillFiletypeBlankProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
FillFiletypeBlank.displayName = 'FillFiletypeBlank';

export default FillFiletypeBlank;