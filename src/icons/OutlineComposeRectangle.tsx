...
export interface OutlineComposeRectangleProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineComposeRectangle: React.FC<OutlineComposeRectangleProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineComposeRectangle.displayName = 'OutlineComposeRectangle';

export default OutlineComposeRectangle;