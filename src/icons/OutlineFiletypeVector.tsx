...
export interface OutlineFiletypeVectorProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineFiletypeVector: React.FC<OutlineFiletypeVectorProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineFiletypeVector.displayName = 'OutlineFiletypeVector';

export default OutlineFiletypeVector;