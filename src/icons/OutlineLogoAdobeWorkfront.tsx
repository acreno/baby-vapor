...
export interface OutlineLogoAdobeWorkfrontProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineLogoAdobeWorkfront: React.FC<OutlineLogoAdobeWorkfrontProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineLogoAdobeWorkfront.displayName = 'OutlineLogoAdobeWorkfront';

export default OutlineLogoAdobeWorkfront;