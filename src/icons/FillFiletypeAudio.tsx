...
export interface FillFiletypeAudioProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const FillFiletypeAudio: React.FC<FillFiletypeAudioProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
FillFiletypeAudio.displayName = 'FillFiletypeAudio';

export default FillFiletypeAudio;