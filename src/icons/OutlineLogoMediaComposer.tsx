...
export interface OutlineLogoMediaComposerProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineLogoMediaComposer: React.FC<OutlineLogoMediaComposerProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineLogoMediaComposer.displayName = 'OutlineLogoMediaComposer';

export default OutlineLogoMediaComposer;