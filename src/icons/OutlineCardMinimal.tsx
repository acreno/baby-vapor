...
export interface OutlineCardMinimalProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineCardMinimal: React.FC<OutlineCardMinimalProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineCardMinimal.displayName = 'OutlineCardMinimal';

export default OutlineCardMinimal;