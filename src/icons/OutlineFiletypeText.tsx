...
export interface OutlineFiletypeTextProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineFiletypeText: React.FC<OutlineFiletypeTextProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineFiletypeText.displayName = 'OutlineFiletypeText';

export default OutlineFiletypeText;