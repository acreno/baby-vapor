...
export interface FillFiletypeSpreadsheetProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const FillFiletypeSpreadsheet: React.FC<FillFiletypeSpreadsheetProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
FillFiletypeSpreadsheet.displayName = 'FillFiletypeSpreadsheet';

export default FillFiletypeSpreadsheet;