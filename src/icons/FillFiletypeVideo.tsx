...
export interface FillFiletypeVideoProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const FillFiletypeVideo: React.FC<FillFiletypeVideoProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
FillFiletypeVideo.displayName = 'FillFiletypeVideo';

export default FillFiletypeVideo;