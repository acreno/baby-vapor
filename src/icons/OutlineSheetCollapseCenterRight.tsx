...
export interface OutlineSheetCollapseCenterRightProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineSheetCollapseCenterRight: React.FC<OutlineSheetCollapseCenterRightProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineSheetCollapseCenterRight.displayName = 'OutlineSheetCollapseCenterRight';

export default OutlineSheetCollapseCenterRight;