...
export interface OutlineLogoDavinciResolveProps {
  className?: string;
  size?: number | string;
  color?: string;
...
export const OutlineLogoDavinciResolve: React.FC<OutlineLogoDavinciResolveProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor',
  style,
...
OutlineLogoDavinciResolve.displayName = 'OutlineLogoDavinciResolve';

export default OutlineLogoDavinciResolve;